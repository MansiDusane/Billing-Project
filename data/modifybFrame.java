...
public class modifybFrame extends JFrame
{
	public modifybFrame()
	{
		...
		newblb.setBounds(210,-60,210,210);
		add(newblb);
			...
			public void actionPerformed(ActionEvent ae)
			{
				...
				if(contactu.equals("") || nameu.equals("") || emailu.equals("") || cont.equals("") || genderu.equals("") || addressu.equals(""))
				{
					...
					try{
						...
						String strup = " Update buyer set name = '"+nameu+"', contact_no = '"+contactu+"', email = '"+emailu+"', address = '"+addressu+"', gender = '"+genderu+"' where contact_no = '"+cont+"';";
						...
						setVisible(false);
						new modifybFrame().setVisible(true);
		...
		deleteb.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent eea)
			{
				...
				int a = JOptionPane.showConfirmDialog(null,"Do you realy want to delete buyer","confirm",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
				if(a==0)
				{
					...
					if(contactu.equals("") || nameu.equals("") || emailu.equals("") || cont1.equals("") || genderu.equals("") || addressu.equals(""))
					{
						...
						try{
							...
							connmu = DriverManager.getConnection("jdbc:mysql://localhost:3306/billmanagementproject","Mansi","Mansi@123");
							stmtmu = connmu.createStatement();
							String strdl = " delete from buyer where contact_no = '"+cont1+"';";
							stmtmu.executeUpdate(strdl);
							System.out.println(strdl);
							JOptionPane.showMessageDialog(null,"Buyer Deleted","Message",JOptionPane.INFORMATION_MESSAGE);
							setVisible(false);
							new modifybFrame().setVisible(true);
						}
						catch(Exception exp)	{
		...
		searchb.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				try
				{
					...
					rs = stmtm.executeQuery(" Select * from buyer where contact_no = "+contact1+";");
					if(rs.next())
					{
