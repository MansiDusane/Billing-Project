...
public class stfdetails extends JFrame
{
	...
	public stfdetails(){
		...
		addComponentListener(new ComponentListener()
		{
			public void componentShown(ComponentEvent e){
						...
						try{
							...
							Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/billmanagementproject","Mansi","mansi@123");
		...
		JLabel newpl=new JLabel("Staff Details");
		newpl.setFont(new Font("Times New Roman",1,40));
		newpl.setBounds(210,-20,350,110);
		add(newpl);
		//new product logo
