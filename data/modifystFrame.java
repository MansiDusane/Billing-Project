...
public class modifystFrame extends JFrame
{
	public modifystFrame()
	{
		...
		JLabel newblb=new JLabel("Update Staff");
		...
		updateb.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				if(contactu.equals("") || nameu.equals("") || emailu.equals("") || cont.equals("") || genderu.equals("") || addressu.equals(""))
				{
					...
					try{
						...
						connmu = DriverManager.getConnection("jdbc:mysql://localhost:3306/billmanagementproject","Mansi","mansi@123");
						stmtmu = connmu.createStatement();
						String strup = " Update staff set stname = '"+nameu+"', contact_no = '"+contactu+"', stemail = '"+emailu+"', staddress = '"+addressu+"', stgender = '"+genderu+"' where contact_no = '"+cont+"';";
						...
						setVisible(false);
						new modifystFrame().setVisible(true);
		...
		deleteb.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent eea)
			{
				...
				int a = JOptionPane.showConfirmDialog(null,"Do you realy want to delete staff","confirm",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
				if(a==0)
				{
					...
					if(contactu.equals("") || nameu.equals("") || emailu.equals("") || cont1.equals("") || genderu.equals("") || addressu.equals(""))
					{
						...
						try{
							...
							connmu = DriverManager.getConnection("jdbc:mysql://localhost:3306/billmanagementproject","Mansi","Mansi@123");
							stmtmu = connmu.createStatement();
							String strdl = " delete from staff where contact_no = '"+cont1+"';";
							stmtmu.executeUpdate(strdl);
							System.out.println(strdl);
							JOptionPane.showMessageDialog(null,"Staff Deleted","Message",JOptionPane.INFORMATION_MESSAGE);
							setVisible(false);
							new modifystFrame().setVisible(true);
						}
						catch(Exception exp)	{
		...
		searchb.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				try
				{
					...
					Class.forName("com.mysql.cj.jdbc.Driver");
					System.out.println("Driver is register");
					connm = DriverManager.getConnection("jdbc:mysql://localhost:3306/billmanagementproject","Mansi","Mansi@123");
					stmtm = connm.createStatement();
					rs = stmtm.executeQuery(" Select * from staff where contact_no = "+contact1+";");
					if(rs.next())
					{
