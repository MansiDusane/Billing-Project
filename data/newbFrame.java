...
public class newbFrame extends JFrame
{
	public newbFrame()
	{
		...
		buyersavebtn.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent bre)
			{
				...
				{
					JOptionPane.showMessageDialog(null,"Enter Details of buyer","Message",JOptionPane.INFORMATION_MESSAGE);
				}
				else
				{
						try
						{
							...
							conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/billmanagementproject","Mansi","mansi@123");
							stmt = conn.createStatement();

							String sqls="Insert into buyer values('"+bName+"','"+bContact_no+"','"+bEmail+"','"+bAddress+"','"+bGender+"');";
