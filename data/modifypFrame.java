...
public class modifypFrame extends JFrame
{
	...
	searchp.addActionListener(new ActionListener()
	{
		public void actionPerformed(ActionEvent ee)
		{
			...
			try{
				...
				Connection connp = DriverManager.getConnection("jdbc:mysql://localhost:3306/billmanagementproject","Mansi","mansi@123");
	...
	updatep.addActionListener(new ActionListener()
	{
		public void actionPerformed(ActionEvent ae)
		{
			...
			if(p_pid.equals("") || p_name.equals("") || p_rate.equals("") || p_active.equals(""))
			{
